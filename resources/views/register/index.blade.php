...
@section('login')
    ...
    <x-form method="POST" class="form-horizontal auth-form">
        ...
        <div class="form-group mb-2">
            <label class="form-label" for="conf_password">Повторите пароль</label>
            <div class="input-group">
                <input type="password" class="form-control" name="conf-password" id="conf_password"
        ...
        <div class="form-group mb-2">
            ...
            <div class="input-group">
                <input type="text" class="form-control" name="mobile number" id="mo_number"
        ...
        <div class="form-group mb-0 row">
            <div class="col-12">
                <button class="btn btn-primary w-100 waves-effect waves-light" type="button">Зарегистрироваться <i
